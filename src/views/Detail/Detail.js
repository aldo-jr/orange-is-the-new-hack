    ...
    return (
      <div className='container'>
        <div className="row justify-content-center my-4">
          <h2 className='we-title'>Cabelo&Cia</h2>
        ...
        <div className='row py-4' style={{background: '#EAFEF7'}}>
          ...
          <div className="col">
            ...
            {this.state.connected ? (
              <div className="row">
                <div className="col">
                  <div className="alert alert-success">
                    ...
                    <p>
                      Assim que Ana Carolina aceitar, vocês poderão ver os contatos uma da outra para iniciar uma
                      conversa!
                    </p>
                  </div>
                </div>
              ...
              <div className="row mb-5">
                <div className="col">
                  <Button color='we-cta' classes='btn-block' onClick={this.connect.bind(this)}>Conecte-se com a
                    empreendedora</Button>
                </div>
              </div>
            )}
          </div>
